<html>
<head>
  <link rel="stylesheet" type="text/css" href="css/wdfooter2.css" />
</head>
<body>
  <footer id="footer" class="footer">
    <div class="wrapper-footer first-footer">
      <div class="mobile-footer-break">
      <p class="footer-item"><a href="#">TREATMENTS</a></p>
      <p class="footer-item"><a href="#">COMPANY</a></p>
      <p class="footer-item"><a href="#">CAREERS</a></p>
    </div>
    <div class="mobile-footer-break">
      <p class="footer-item"><a href="https://fargowellnessdistrict.brilliantconnections.com/">SHOP</a></p>
      <p class="footer-item"><a href="#">PATIENT RESOURCES</a></p>
    ...
    <div class="wrapper-footer middle-footer">
                                    <p class="footer-menu-header-text">CONTACT & DIRECTIONS</p>
                                      ...
                                      <p class="footer-menu-subheader-text" href="tel:877.568.4594" style="cursor:pointer;">CALL: 877.568.3594</p>
    ...
    <div class="wrapper-footer bottom-footer">
      <form action="/action.php" class="footer-form">
        <div class="footer-form-content-wrapper">
        <i class="fas fa-dove footer-icon"></i>
        <p class="footer-form-header-text">Join Wellness District</p>
        <input class="footer-input footer-input-name" type="text" id="name" name="name" placeholder="Your Name"><br>
        <input class="footer-input footer-input-name" type="email" id="email" name="email" placeholder="Your Email"><br>
        <input class="footer-form-submit" id="formsubmit" type="submit" value="Sign Up">
      </div>
    </form>
