...
<body>
  <footer id="footer" class="footer">
    <div class="wrapper-footer first-footer">
      ...
      <p class="footer-item"><a href="aesthetic-services.php">TREATMENTS</a></p>
      <p class="footer-item"><a href="coming-soon.php">COMPANY</a></p>
    ...
    <div class="wrapper-footer middle-footer">
                                    <p class="footer-menu-header-text">CONTACT & DIRECTIONS</p>
                                      ...
                                      <p class="footer-menu-subheader-text"><a href="tel:877.568.4594" style="cursor:pointer;">CALL: 877.568.3594</a></p>
    ...
    <div class="wrapper-footer bottom-footer">
      <form action="/action.php" class="footer-form">
        ...
        <p class="footer-form-header-text">Join Wellness District<br>Text Club</p>
