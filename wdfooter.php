...
<body>
  <footer id="footer" class="footer">
    ...
    <div class="wrapper-footer bottom-footer">
      <form action="action.php" method="post" class="footer-form">
        ...
        <input class="footer-input footer-input-name" type="tel" id="tel" name="tel" placeholder="Your Cell Phone Number.."><br>
